...
#define NUSER 458293
#define NMOVIE 17770
#define NTRAIN 94362233
#define NVALID 1965045
#define NHIDDEN 1964391
#define NPROBE 1374739
#define QUAL 2749898
#define NF 500 // number of latent factors
using namespace std;
...
#iteration = 82
rmse on quiz set = 0.89499
output output_svd(f=200)1.dta generated.
*/
...
int main(){
	...
	for(int i = 0; i <= 80; i++){
		...
		if(testscore  < mintestscore){
			...
			model.predict(qual, "output_svd(f=500)_predict.dta");
		}
	}
}
