...
int main(int argc, char **argv) {
    ...
    ifstream infile1("../../data/mu/1bethere.dta");
    ...
    current_user = 1;
    ifstream infile2("../../data/1bethere.dta");
    float numerator = 0.0;
    ...
    ifstream infile4("../../data/1bethere.dta");
    current_user = 1;
    float estimate;
    while (!infile4.eof()) {
    ...
    current_user = 1;
    ifstream infile3("../../data/1bethere.dta");
    numerator = 0.0;
    denominator = 0.0;
    while (!infile3.eof()) {
    ...
    current_user = 1;
    ifstream time_data("../../data/1bethere.dta");
    numerator = 0.0;
    denominator = 0.0;
    float xui;
    while (!time_data.eof()) {
    ...
    ifstream infile("../../data/3bethere.dta");
    ofstream outfile("../../data/global_results_no_probe.dta");
    int current = 0;
    while (!infile.eof()) {
        if (current % 100000 == 0) {
            cout << "generating qual " << current << endl;
